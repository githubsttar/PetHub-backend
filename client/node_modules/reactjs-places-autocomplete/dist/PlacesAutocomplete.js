...
var PlacesAutocomplete = function (_React$Component) {
  ...
  function PlacesAutocomplete(props) {
    ...
    _this.init = function () {
      if (!window.google) {
        throw new Error('[reactjs-places-autocomplete]: Google Maps JavaScript API library must be loaded. See: https://github.com/joelwmale/reactjs-places-autocomplete#load-google-library');
      }

      if (!window.google.maps.places) {
        throw new Error('[reactjs-places-autocomplete]: Google Maps Places library must be loaded. Please add `libraries=places` to the src URL. See: https://github.com/joelwmale/reactjs-places-autocomplete#load-google-library');
      }
    ...
    _this.handleSelect = function (suggestion) {
      ...
      if (_this.props.onSelect) {
        _this.props.onSelect(description, placeId, suggestion);
      } else {
        _this.props.onChange(description);
      }
    };
    ...
    _this.handleEnterKey = function () {
      ...
      if (activeSuggestion === undefined) {
        _this.handleSelect(_this.props.value);
      } else {
    ...
    _this.getInputProps = function () {
      ...
      if (options.hasOwnProperty('value')) {
        throw new Error('[reactjs-places-autocomplete]: getInputProps does not accept `value`. Use `value` prop instead');
      }

      if (options.hasOwnProperty('onChange')) {
        throw new Error('[reactjs-places-autocomplete]: getInputProps does not accept `onChange`. Use `onChange` prop instead');
      }
...
PlacesAutocomplete.defaultProps = {
  ...
  onError: function onError(status, _clearSuggestions) {
    return console.error('[reactjs-places-autocomplete]: error happened when fetching data from Google Maps API.\nPlease check the docs here (https://developers.google.com/maps/documentation/javascript/places#place_details_responses)\nStatus: ', status);
  },
